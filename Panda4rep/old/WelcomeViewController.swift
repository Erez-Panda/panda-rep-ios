...
class WelcomeViewController: UIViewController, UIPageViewControllerDataSource{
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        if let credentials : AnyObject = defaultUser.objectForKey("credentials") {
            LoginUtils.login(credentials["username"]as! String, password: credentials["password"] as! String, sender: self, successSegue: "showMainFromWelcomeSegue", completion: {result -> Void in
